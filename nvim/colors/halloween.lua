...
M.config = function()
  ...
  hi(0, "CursorLine",    { bg = c.dark_gray })
  hi(0, "CursorColumn",  { bg = c.dark_gray })
  hi(0, "Visual",        { bg = c.comment })
  hi(0, "LineNr",        { fg = c.comment, bg = c.bg })
  hi(0, "CursorLineNr",  { fg = c.yellow, bg = c.dark_gray })
  ...
  hi(0, "Todo",          { fg = c.red, bg = c.dark_gray, bold = true })
  ...
  hi(0, "TelescopePromptNormal",  { fg = c.fg, bg = c.dark_gray })
  hi(0, "TelescopePromptPrefix",  { fg = c.orange })
  hi(0, "TelescopeSelection",     { fg = c.orange, bg = c.dark_gray })
  ...
  -- bufferline
  hi(0, "BufferLineFill",             { bg = c.dark_gray })
  hi(0, "BufferLineBackground",       { fg = c.comment, bg = c.dark_gray })
  ...
  hi(0, "BufferLineSeparatorVisible",  { fg = c.dark_gray })
